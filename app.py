...
st.write("Upload a Sanskrit manuscript → OCR → Mistral AI cleans it → Translates into Indic languages + English.")
...
def load_translation_models():
    ...
    st.info("⏳ Loading AI4Bharat IndicTrans2 model (this may take a few minutes on first run)...")
...
def translate_sanskrit(cleaned_sanskrit, tokenizer_indic, model_indic, translator, DEVICE):
    """Translate Sanskrit into Indic languages and English."""
    src_lang = "san_Deva"
    ...
    for tgt_lang in target_langs:
        ...
        english_trans = translator.translate(cleaned_sanskrit, src='sa', dest='en').text
