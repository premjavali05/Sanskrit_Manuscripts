...
def load_translation_models():
    ...
    model_name_indic = os.path.join(os.getcwd(), "indicTrans2_new")  # Fixed: Removed extra "final/"
    
    # Debug: Print path for verification (remove after testing)
    print(f"Loading model from: {model_name_indic}")
    if not os.path.exists(model_name_indic):
        raise ValueError(f"Model path does not exist: {model_name_indic}. Check your directory structure.")
